...
su $USER_NAME -c "yay --noconfirm -S sway swayidle alacritty cage \
  ...
  rsync zathura zathura-pdf-mupdf imv mpv youtube-dl firefox libnotify \
  ...
  fuse fzf sshfs gocryptfs htop wf-recorder mlocate ulauncher spotify \
